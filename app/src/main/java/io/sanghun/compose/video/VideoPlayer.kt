...
import fe.dumbtok.composable.createExoPlayer
...
//    mediaItems: List<VideoPlayerMediaItem>,
    ...
    LaunchedEffect(mediaSource, player) {
//        val exoPlayerMediaItems = withContext(Dispatchers.IO) {
//            mediaItems.map { it.createMediaItem(context) }
//        }

        player.setMediaSources(mediaSource)
